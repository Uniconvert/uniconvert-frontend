...
import { findPotCategory } from '@/features/pots/potCategoryOptions'
import { useI18n } from '@/i18n/I18nContext'
import type { Pot } from '@/features/pots/types'

type PotCardData = Pick<Pot, 'name' | 'icon' | 'representativeImageKey' | 'imageSrc' | 'targetAmount' | 'savedAmount' | 'completedAt'>
